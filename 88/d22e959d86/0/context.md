...
in @ch05/04_evaluation/generate_synthetic_qa_pairs.sh, rename `num-generate` with `num-docs` to be consistent with the python scripts at `03_generate_qa_pairs.py`
